...
class ReceivablePayableReport:
	...
	def get_future_payments_from_journal_entry(self):
		...
		# one row per voucher so each invoice keeps its own future amount (consumer keys by invoice+party)
		query = query.groupby(jea.reference_name, jea.party, jea.party_type, je.posting_date, je.cheque_no)
